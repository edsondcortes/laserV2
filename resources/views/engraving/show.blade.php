                        ...
                        <div class="row">
                            ...
                            @foreach ($budgetInfos['data']['customer'] as $budgetInfo)
                                <div class="input-field col 12 m4">
                                    <input value="{{ mb_convert_case($budgetInfo['nomerazaosocial'], MB_CASE_TITLE, "UTF-8") }}" disabled class="colorlabel">
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="row">
                                ...
                                <div class="input-field col s12 m4">
                                    <input value="{{ $description = mb_convert_case($item['description'], MB_CASE_TITLE, "UTF-8") }}" disabled class="colorlabel">
                                ...
                                <div class="input-field col s12 m4">
                                    <input value="{{ $background = substr_replace($item['background'], " ", 3, 0) }}" disabled class="colorlabel">
                                ...
                                @if ($item->deliveryMethod == 'Despachar')
                                    @foreach ($budgetInfos['data']['customer'] as $budgetInfo)
                                        ...
                                        <div class="input-field col s12 m2">
                                            <input value="{{ $budgetInfo['enderecos']['0']['numero'] }}" disabled class="colorlabel">
                                            <label class="active">Número</label>
                                        </div>
                                        <div class="input-field col s12">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        @if ($item->engraving != null)
                                            <td>{{ $item->userengraving->name }} - {{ $item->cut->format('d/m/Y - H:i') }}</td>
                                            <td><i class="material-icons check" style="color: #03a9f4">check</i></td>
                                        @else
                                            <td>Procedimento não Realizado</td>
                                            <td>
                                                <a href="{{ route('engraving.updateEngraving', $item->id) }}">
                                                    <i class="material-icons play_circle_outline">play_circle_outline</i>
                                                </a>
                                            </td>
                                        @endif
                                    </tr>
                            ...
                            <div class="row">
                                <div class="col s12 mt-2">
                                    <h6><i class="material-icons error">error</i> Erros</h6>
                                </div>
                                <form method="POST" action="{{ route('engraving.store') }}">
                                    @csrf
                                    <input hidden name="id_item" value="{{ $item->id }}">
                                    <input hidden name="budget" value="{{ $budgetInfos['data']['iddocumento'] }}">
                                    <div class="input-field col s12 width-80">
                                        <textarea name="erro" id="error" class="materialize-textarea validate"></textarea>
                                    </div>
                                    <div class="input-field col s12 m2 center">
                                        <button class="btn-floating mb-1 waves-effect waves-light">
