...
return [
    'custom' => [
        ...
        'templateTitle' => 'Sis. Laser', //template Title can be changes default('Materialize)
        ...
        'largeScreenLogo' => 'images/logo/logo-gray.png', //we used saparete log image for large screen and small
        'smallScreenLogo' => 'images/logo/logo-white.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
