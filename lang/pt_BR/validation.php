...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'cidade' => 'Cidade',
        'telefone' => 'Telefone',
        'posicao' => 'Posição do Cubo',
        'tipo' => 'Tipo de Imagem',
        'fundo' => 'Fundo da Imagem',
        'descricao' => 'Descrição',
        'hotelname' => 'Hotel',
        'hotelroom' => 'Quarto',
        'hoteldate' => 'Data de Saída',
        'hotelhour' => 'Horário de Saída',
        'localdatedelivery' => 'Data de Entrega',
        'localhourdelivery' => 'Horário de Entrega',
        'seasonstreet' => 'Rua',
        'seasonnumber' => 'Número',
        'seasondistrict' => 'Bairro',
        'seasoncity' => 'cidade',
        'seasondatedelivery' => 'Data de Entrega',
        'seasonhour' => 'Horário Preferencial',
        'seasondatasaida' => 'Data de Saída do Cliente',
        'position' => 'Posição do Cubo',
        'imagetype' => 'Tipo de Imagem',
        'imageBackground' => 'Fundo da Imagem',
        'deliveryType' => 'Forma de Entrega',
        'production' => 'Forma de Produção'
    ],
